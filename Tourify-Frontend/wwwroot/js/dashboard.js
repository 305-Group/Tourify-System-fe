<script>
      ...
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        // 🧠 Destroy previous collapse instance if exists
        if (submenu.classList.contains("show")) {
          submenu.classList.remove("show");
        }


        // 🧠 Dùng Collapse bằng tay
        if (pageKey === "addTour" || pageKey === "tourList") {
        ...
        // Only init addTour logic if needed
        if (pageKey === "addTour") {
          setTimeout(() => {
            initAddTourPage();
          }, 0);
